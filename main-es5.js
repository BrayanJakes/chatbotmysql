...
var ChatConfigComponent = /** @class */ (function () {
    function ChatConfigComponent(chatbotService) {
    ...
    ChatConfigComponent.prototype.agregarInstruccion = function (form) {
        this.chatbotConfig.instrucciones.push({ opcion: form.value.instrucciones });
        form.value.instrucciones = '';
    };
    ChatConfigComponent.prototype.opcion2 = function (opcionSecundaria, opcionPrimaria) {
        console.log(opcionSecundaria, opcionPrimaria);
    };
    ChatConfigComponent.prototype.Eliminar = function (i) {
        this.chatbotConfig.instrucciones.splice(i, 1);
    };
    ChatConfigComponent.ctorParameters = function () { return [
...
var getRandomMessage = function () { return randomMessages[rand(randomMessages.length)]; };
var ChatWidgetComponent = /** @class */ (function () {
    function ChatWidgetComponent(chatbotService) {
        this.chatbotService = chatbotService;
        this.theme = 'blue';
        this.chatbotMensajes = {};
        this.formularioBot = {
    ...
    ChatWidgetComponent.prototype.addMessage = function (from, text, type) {
    ...
    ChatWidgetComponent.prototype.randomMessage = function () {
    ...
    ChatWidgetComponent.prototype.ngOnInit = function () {
        ...
        setTimeout(function () {
            _this.addMessage(_this.operator, _this.chatbotService.chatbotMensajes.mensajeInicial, 'received');
        }, 1500);
        setTimeout(function () {
            _this.addMessage(_this.operator, "para empezar dinos como te llamas?", 'received');
        }, 3000);
    };
    ...
    ChatWidgetComponent.prototype.sendMessage = function (_a) {
        ...
        if (this.formularioBot.nombre === '') {
            ...
            return setTimeout(function () { _this.addMessage(_this.operator, "Ahora ingresa tu email", 'received'); }, 1500);
        }
        ;
        if (this.formularioBot.email === '') {
            this.formularioBot.email = message;
            return setTimeout(function () { _this.addMessage(_this.operator, "Ahora ingresa tu telefono", 'received'); }, 1500);
        }
        if (this.formularioBot.telefono === '') {
            this.formularioBot.telefono = message;
            return setTimeout(function () {
                _this.datosIngresadoCorrectos = false;
                _this.addMessage(_this.operator, "!Estos son tus datos que ingresastes: \n\n      nombre: " + _this.formularioBot.nombre + ",\n      email: " + _this.formularioBot.email + ",\n      telefono: " + _this.formularioBot.telefono + ".\n\n      Son tus datos correctos?\n      ", 'received');
            }, 1500);
        }
        setTimeout(function () {
            _this.addMessage(_this.operator, "No nos hemos olvidado de usted " + _this.formularioBot.nombre + ", les notificaremos a travez de su correo o celular sobre nuestro servicio ", 'received');
        }, 1500);
    };
    ...
    ChatWidgetComponent.prototype.preguntas = function (instruccion) {
        var _this = this;
        this.addMessage(this.client, instruccion, 'sent');
        if (instruccion === 'Si') {
            return setTimeout(function () {
                _this.chatbotService.enviarDatosCliente(_this.formularioBot).subscribe(function (resp) {
                    console.log(resp);
                });
                _this.listaDeProductos = true;
                _this.datosIngresadoCorrectos = true;
                _this.addMessage(_this.operator, "- Bienvenido " + _this.formularioBot.nombre + ", Te gustaria comprar uno de nuestros productos o gustas de esperar a que te atienda uno de nuestros asesores de ventas ", 'received');
            }, 1500);
        }
        if (instruccion === 'No') {
            this.datosIngresadoCorrectos = true;
        ...
        if (instruccion === 'compra de producto') {
            return setTimeout(function () {
                _this.listaDeProductos = false;
                _this.addMessage(_this.operator, "Acontinuacion aqui te damos varios productos que tenemos en venta", 'received');
            }, 2000);
        }
        if (instruccion === 'esperar asesor de ventas') {
            return setTimeout(function () {
                _this.listaDeProductos = false;
                _this.addMessage(_this.operator, "Muy bien, en breve uno de nuestro asesores de venta lo estara llamando atravez de su celular o por su email, este pendiente porfavor. Muchas gracias", 'received');
            }, 2000);
        }
        if (instruccion === 'compra de hosting') {
            return setTimeout(function () {
                _this.compraProducto = false;
                _this.addMessage(_this.operator, "Aqui tenemos el precio de nuestro hosting", 'received');
            }, 2000);
        }
        if (instruccion === 'compra de reseller') {
            return setTimeout(function () {
                _this.compraProducto = false;
                _this.addMessage(_this.operator, "Aqui tenemos el precio de nuestro reseller hosting", 'received');
            }, 2000);
        }
        if (instruccion === '6$ Trimestral') {
            return setTimeout(function () {
                _this.compraDeHosting = false;
                var compra = { producto: 'Hosting', precio: instruccion, estatus: 'Pendiente' };
                _this.chatbotService.enviarProductos(compra).subscribe(function (resp) {
                    console.log(resp);
                });
                _this.addMessage(_this.operator, "Acaba de comprar nuestro producto de hosting por " + instruccion + ", en breve uno de nuestro asesore se pondra en contacto contigo atravez de tu celular o email, este atento porfavor, Muchas gracias", 'received');
            }, 2000);
        }
        if (instruccion === '8$ Semestral') {
            return setTimeout(function () {
                _this.compraDeHosting = false;
                _this.chatbotService.enviarProductos({ producto: 'Hosting', precio: instruccion, estatus: 'Pendiente' }).subscribe(function (resp) {
                    console.log(resp);
                });
                _this.addMessage(_this.operator, "Acaba de comprar nuestro producto de hosting por " + instruccion + ", en breve uno de nuestro asesore se pondra en contacto contigo atravez de tu celular o email, este atento porfavor, Muchas gracias", 'received');
            }, 2000);
        ...
        if (instruccion === '10$ Trimestral') {
            return setTimeout(function () {
                _this.chatbotService.enviarProductos({ producto: 'Reseller Hosting', precio: instruccion, estatus: 'Pendiente' }).subscribe(function (resp) {
                    console.log(resp);
                });
                _this.compraDeResellerHosting = false;
                _this.addMessage(_this.operator, "Acaba de comprar nuestro producto de reseller hosting por " + instruccion + ", en breve uno de nuestro asesore se pondra en contacto contigo atravez de tu celular o email, este atento porfavor, Muchas gracias", 'received');
            }, 2000);
        }
    ...
    ChatWidgetComponent.prototype.preguntas2 = function (opcion, tarea) {
        var _this = this;
        console.log(tarea);
        this.addMessage(this.client, opcion, 'sent');
        setTimeout(function () {
            _this.addMessage(_this.operator, tarea, 'received');
        }, 1500);
    };
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(chatbotService) {
        this.chatbotService = chatbotService;
        this.datosClientes = [];
        this.datosProductos = [];
    }
    ...
    DashboardComponent.prototype.listarClientes = function () {
        var _this = this;
        this.chatbotService.listarDatosCliente().subscribe(function (resp) {
            // console.log(resp)
            _this.datosClientes = resp;
        });
    };
    DashboardComponent.prototype.listarProductos = function () {
        var _this = this;
        this.chatbotService.listarProductos().subscribe(function (resp) {
            _this.datosProductos = resp;
        });
    };
...
var ElementModule = /** @class */ (function () {
    function ElementModule(injector) {
        this.injector = injector;
    }
    ElementModule.prototype.ngDoBootstrap = function () {
        var chatConfig = Object(_angular_elements__WEBPACK_IMPORTED_MODULE_4__["createCustomElement"])(_chat___WEBPACK_IMPORTED_MODULE_5__["ChatConfigComponent"], {
            injector: this.injector,
        });
        var chatWidget = Object(_angular_elements__WEBPACK_IMPORTED_MODULE_4__["createCustomElement"])(_chat___WEBPACK_IMPORTED_MODULE_5__["ChatWidgetComponent"], {
            injector: this.injector,
        });
        customElements.define('chat-config', chatConfig);
        customElements.define('chat-widget', chatWidget);
    };
    ElementModule.ctorParameters = function () { return [
...
var ChatbotService = /** @class */ (function () {
    ...
    ChatbotService.prototype.enviarDatosCliente = function (body) {
        return this.http.post(this.URI + "agregarCliente.php", JSON.stringify(body));
    };
    ChatbotService.prototype.enviarProductos = function (body) {
        return this.http.post(this.URI + "agregarProducto.php", JSON.stringify(body));
    };
    ChatbotService.prototype.listarDatosCliente = function () {
        return this.http.get(this.URI + "listarClientes.php");
    };
    ChatbotService.prototype.listarProductos = function () {
